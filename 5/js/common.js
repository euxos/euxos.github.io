$(document).ready(function() {
	...
	$(".mc_item").after("<div class='mc_item_wrap_af'></div>");
	$(".mc_toggle").click(function() {
		if($(this).parent().parent().children(".mc_note").is(":visible")) {
			$(this).parent().parent().children(".mc_note").hide();
			$(this).parent().parent().children(".mc_item_wrap_af").hide();
			$(".mc_item_wrap").removeClass("active");
		} else {
			$("body .mc_wrap .mc_item_wrap > .mc_note, .mc_item_wrap_af").hide();
			$(".mc_item_wrap").removeClass("active");
			$(this).parent().parent().addClass("active");
			$(this).parent().parent().children(".mc_note").slideDown();
